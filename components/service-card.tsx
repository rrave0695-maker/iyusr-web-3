...
export function ServiceCard({ icon: Icon, title, description, isVisible, index }: ServiceCardProps) {
  return (
    <div
    ...
    >
      {/* Icon */}
      <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-cyan-500/20 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
